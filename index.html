...
<head>
    ...
    <title>Consking - Industrial Construction Template</title>
...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="header-contact text-right">
                                <a href="#"><i class="fa fa-clock-o"></i> Sun - Thu 09:00 - 06:00</a>
                                <a href="#"><i class="fa fa-envelope"></i> support24@ex.com</a>
                                <a href="#"><i class="fa fa-phone"></i> +111 758 362 125</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="slider-area">
        <div class="slider-active owl-carousel">
            <!-- Single Slider Area -->
            <div class="single-slider" style="background-image: url(img/slider/slider-img-1.jpg)">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="slider-content">
                                <p data-animation="fadeInDown" data-delay="900ms">28 Years of Ecperience We Provide Serives</p>
                                <h3 data-animation="fadeInDown" data-delay="400ms">Construction Industrial Company</h3>
                                <div class="slider-btn mt-30" data-animation="fadeInDown" data-delay="90ms">
                                    <a class="boxed-btn2 black-bg" href="#">Our Services <i class="Flaticon flaticon-right-arrow"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-slider" style="background-image: url(img/slider/slider-2.jpg)">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="slider-content">
                                <h3 data-animation="fadeInDown" data-delay="900ms">We Build your Dream</h3>
                                <p data-animation="fadeInDown" data-delay="400ms">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste voluptate reprehenderit.</p>
                                <div class="slider-btn mt-30" data-animation="fadeInDown" data-delay="90ms">
                                    <a class="boxed-btn2 black-bg" href="#">Our Services <i class="Flaticon flaticon-right-arrow"></i></a>
                                </div>
                            </div>
            ...
            <div class="single-slider" style="background-image: url(img/slider/slider-img-1.jpg)">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="slider-content">
                                <p data-animation="fadeInDown" data-delay="900ms">Quality work. Trustable service.</p>
                                <h3 data-animation="fadeInDown" data-delay="400ms">We provide your Industrial solution</h3>
                                <div class="slider-btn mt-30" data-animation="fadeInDown" data-delay="90ms">
                                    <a class="boxed-btn2 black-bg" href="#">Our Services <i class="Flaticon flaticon-right-arrow"></i></a>
                                </div>
                            </div>
            ...
            <div class="row justify-content-end">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="section-title text-white">
                        <h3>Our Project<br>
                            Portfolio &amp; Works</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa impedit quae aspernatur rerum explicabo illum fugit inventore enim unde temporibus.</p>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="section-title">
                        ...
                        <h3>We building everything that you needed</h3>
                        <p class="para-text">
                ...
                <div class="col-lg-6">
                    <div class="about-thumb">
                        <img src="img/background-img/2.jpg" alt="">
                        <a class="video-icon popup-video pulse wow zoomIn" data-wow-delay="0.4s" href="https://www.youtube.com/watch?v=vb9uYBtqmeM">
    ...
    <!-- Call to action Area -->
    <div class="call-to-action-area bg-img bg-fixed section-padding" style="background-image: url(img/background-img/bg-img-3.jpg)">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-8">
                    <div class="call-to-action-content text-center">
                        ...
                        <h4>(+3458)-856-654-1234</h4>
                        <p class="text-white">Street 6 ,45 New york City</p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single-team-area text-center mb-30 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="member-info">
                            <h5>Jhon Hasla</h5>
                            <h6>Ceo &amp; Architer</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eum libero, consequatur, fugit illo nulla eveniet.</p>
                            <!-- Icon -->
                            <div class="member-contact-icon">
    ...
    <!-- Blog Area -->
    <div class="blog-area sction-padding-100-70" style="background-image: url(img/background-img/pattern.png);">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="section-title text-center mb-65">
                    <span>Latest news &amp; blog</span>
                    <h3>Working with hard</h3>
                </div>
            </div>
                    ...
                    <div class="single-blog-area mb-30">
                        ...
                        <div class="blog-content">
                            <a href="single-blog.html">
                                <h3>The 9 Best Construction Guides of 2019</h3>
                            </a>
                            <!-- Comment -->
                            <div class="comment mb-15">
                                <a class="mr-3" href="#"><i class="fa fa-commenting-o" aria-hidden="true"></i> Comment</a>
                                <a href="#"><i class="fa fa-share" aria-hidden="true"></i> Share</a>
                            </div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut velit, deserunt incidunt minima amet, blanditiis qui asperiores!</p>
    ...
    <!-- cta-area-start -->
    <div class="cta-area bg-img bg-overlay-2" style="background-image: url(img/background-img/1.jpg)">
        <div class="container">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-sm-6 col-md-3 col-xl-3">
                    <div class="single-footer-widget footer_icon">
                        ...
                        <a class="footer-button" href="#">Request with onlineform</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="copyright_part_text text-center">
                        <p class="footer-text m-0">Copyright All rights reserved <a class="ml-1" href="#">Theme-zome</a></p>
                    </div>
                </div>
            </div>
        </div>
